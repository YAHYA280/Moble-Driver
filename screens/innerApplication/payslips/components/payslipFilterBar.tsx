...
interface PayslipFilterBarProps {
  ...
  onFiltersChange: (filters: Partial<PayslipFilters>) => void;
  onClearFilters: () => void;
  style?: ViewStyle;
}

export const PayslipFilterBar: React.FC<PayslipFilterBarProps> = ({
  filters,
  onFiltersChange,
  onClearFilters,
  style,
  ...
  const [localFilters, setLocalFilters] = useState<PayslipFilters>(filters);
  ...
  const handleFilterChange = (key: keyof PayslipFilters, value: any) => {
  ...
  const getActiveFiltersDisplay = () => {
    ...
    if (filters.month) {
      ...
      if (month) displays.push(month.label);
    }
    if (filters.status) {
            ...
            <TouchableWithoutFeedback>
              <View style={styles.modalContent}>
                <View style={styles.modalHeader}>
                  <Text style={styles.modalTitle}>Filtrer les bulletins</Text>
                  <TouchableOpacity
                    ...
                    <View style={styles.optionRow}>
                      {months.map((month) => (
                        <TouchableOpacity
                          ...
                          style={[
                            styles.optionChip,
                            localFilters.month === month.value &&
                              styles.activeOptionChip,
                          ]}
                          onPress={() =>
